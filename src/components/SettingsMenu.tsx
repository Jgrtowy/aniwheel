...
export default function SettingsMenu() {
    const { imageSize, setImageSize, showRecommendations, setShowRecommendations, blurEffects, setBlurEffects } = useSettingsStore();
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
                <div className="flex flex-col p-2 gap-2">
                    ...
                    <ToggleGroup type="single" variant="outline" value={imageSize} onValueChange={setImageSize} className="mt-1" aria-label="Image Size">
                        <ToggleGroupItem value="medium">M</ToggleGroupItem>
                        <ToggleGroupItem value="large">L</ToggleGroupItem>
                        <ToggleGroupItem value="extraLarge">XL</ToggleGroupItem>
                    </ToggleGroup>
                </div>
                ...
                <div className="flex flex-col justify-between p-2 gap-2">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-muted-foreground">(Anilist only)</span>
                    </div>
                </div>
                <DropdownMenuSeparator className="my-1" />
                <div className="flex flex-col p-2 gap-2">
                    <Label className="text-xs">Blur effects</Label>
                    <span className="text-xs text-muted-foreground">Enables blur effects on cards and backgrounds.</span>
                    <div className="flex items-center gap-2">
