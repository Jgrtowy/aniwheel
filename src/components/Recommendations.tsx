                            ...
                            {recommendations
                                ...
                                .map((rec) => (
                                    <div key={rec.mediaRecommendation.id} className="flex justify-between">
                                        <div className="flex items-end mb-2 rounded-lg p-1 w-1/3 aspect-square" style={{ backgroundImage: rec.media.image ? `url(${rec.media.image})` : "none", backgroundSize: "cover", backgroundPosition: "center" }}>
                                            <h3 className="font-medium w-fit max-w-full text-xs leading-tight sm:line-clamp-2 line-clamp-1 backdrop-blur-2xl text-white backdrop-brightness-75 p-1 border rounded-lg">
                                        ...
                                        <div className="flex flex-col justify-between w-1/3 aspect-square mb-2 rounded-lg p-1" style={{ backgroundImage: rec.mediaRecommendation.image ? `url(${rec.mediaRecommendation.image})` : "none", backgroundSize: "cover", backgroundPosition: "center" }}>
