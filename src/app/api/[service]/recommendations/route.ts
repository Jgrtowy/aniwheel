    ...
    const formattedList: Recommendations[] = mediaList.map(
        (item: {
            ...
            mediaRecommendation: {
                ...
                image: {
                    extraLarge: item.mediaRecommendation.coverImage.extraLarge,
                    large: item.mediaRecommendation.coverImage.large,
                    medium: item.mediaRecommendation.coverImage.medium,
                },
